  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 rounded-2xl p-px [mask:linear-gradient(#000,#000)_content-box,linear-gradient(#000,#000)_padding-box] [mask-composite:exclude]"
      />
      {/* Inner card */}
