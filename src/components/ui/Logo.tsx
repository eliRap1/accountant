...
export default function Logo({ className = "", showWordmark = true }: Props) {
  return (
    <a href="#top" className={`group flex items-center gap-2.5 ${className}`}>
      ...
      >
        <defs>
          <linearGradient id="acg-logo-gradient" x1="0" y1="0" x2="1" y2="1">
        ...
        <rect x="13" y="14" width="14" height="2.4" rx="1" fill="url(#acg-logo-gradient)" />
        <rect x="13" y="19" width="10" height="2.4" rx="1" fill="#10b981" opacity="0.85" />
        <rect x="13" y="24" width="14" height="2.4" rx="1" fill="url(#acg-logo-gradient)" />
