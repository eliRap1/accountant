    ...
    <section id="contact" className="relative mx-auto w-full max-w-7xl px-6 py-32">
      ...
      >
        ...
        <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <Field label="Full name" type="text" placeholder="Jane Doe" name="fullName" />
            <Field label="Work email" type="email" placeholder="jane@company.com" name="email" />
            <Field label="Company" type="text" placeholder="Acme, Inc." name="company" />
            <div>
