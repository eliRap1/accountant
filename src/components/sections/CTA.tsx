    ...
    <section id="contact" className="relative mx-auto w-full max-w-7xl px-6 py-32">
      ...
      >
        ...
        <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <Field id="contact-name" label="Full name" type="text" placeholder="Jane Doe" />
            <Field id="contact-email" label="Work email" type="email" placeholder="jane@company.com" />
            <Field id="contact-company" label="Company" type="text" placeholder="Acme, Inc." />
            <div>
              <label
...
function Field({
  ...
  // Derive a name from the id (e.g. "contact-email" → "email")
