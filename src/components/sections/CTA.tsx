    ...
    <section id="contact" className="relative mx-auto w-full max-w-7xl px-6 py-32">
      ...
      >
        ...
        <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <Field label="Full name" id="field-name" name="name" type="text" placeholder="Jane Doe" />
            <Field label="Work email" id="field-email" name="email" type="email" placeholder="jane@company.com" />
            <Field label="Company" id="field-company" name="company" type="text" placeholder="Acme, Inc." />
            <div>
